...
namespace AutoscaleDemo
{
    ...
    public sealed class Program
    {
        ...
        private static CosmosClientOptions cosmosClientOptions = new CosmosClientOptions
        {
            ...
            ApplicationRegion = Regions.AustraliaSoutheast, // Set the write region of your Azure Cosmos DB account. This should be in the same region as your VM.
            ...
            MaxRetryAttemptsOnRateLimitedRequests = 0, // Retry policy - retry up to 10 times if requests are rate-limited (429)
        ...
        private async Task SetupCosmosResources()
        {
            ...
            container = await cosmosClient.GetDatabase(DatabaseName).CreateContainerIfNotExistsAsync(containerProperties);
